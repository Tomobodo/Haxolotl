...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Thomas BAUDON", "ld28", "com.pixodrome.ld28.ld28", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.pixodrome.ld28.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (com.pixodrome.ld28.Main, Reflect.field (com.pixodrome.ld28.Main, "main"), []);
...
@:keep class DocumentClass extends com.pixodrome.ld28.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ld28", null, { width: 800, height: 480 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.pixodrome.ld28.Main, []);
			}
...
import com.pixodrome.ld28.Main;
